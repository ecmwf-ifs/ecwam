...
function( ecwam_add_test test_name )
    ...
    if( ecwam_add_test_PREC )
      set( test_precision ${ecwam_add_test_PREC} )
    else()
      set( test_precision dp )
    endif()
    ...
    set( PREPROC ecwam-preproc-${test_precision} )
    set( PRESET  ecwam-preset-${test_precision} )
    set( CHIEF   ecwam-chief-${test_precision} )
    ...
    if( NOT TEST ${test_name_preproc} )
      ...
      file( APPEND ${run_filename} "${ECWAM_PROJECT_NAME}-run-preproc --run-dir=${run_dir_preproc} \"\${@}\" \n" )
    ...
    if( NOT TEST ${test_name_preset} )
      ...
      file( APPEND ${run_filename} "${ECWAM_PROJECT_NAME}-run-preset --run-dir=${run_dir_preset} \"\${@}\" \n" )
    ...
    file( APPEND ${run_filename} "${ECWAM_PROJECT_NAME}-run-model --run-dir=${run_dir} \"\${@}\" \n" )
