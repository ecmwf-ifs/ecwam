...
!     MINIMUM PHILLIPS PARAMETER ALLOWED :  ALPHAPMINFAC/WAVE_AGE
      REAL(KIND=JWRB), PARAMETER :: ALPHAPMINFAC=0.05_JWRB
...
!     ANG_GC = ANG_GC_A+ANG_GC_B*TANH(ANG_GC_C*(UTOP(IJ)-ANG_GC_D))
      REAL(KIND=JWRB) :: ANG_GC_A, ANG_GC_B, ANG_GC_C, ANG_GC_D
