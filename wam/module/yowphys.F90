...
!     *BMAXOKAPDTH*      DELTH* DELTA_THETA*BETAMAXOXKAPPA2/XKAPPA
...
!debile test2      REAL(KIND=JWRB), PARAMETER :: SWELLF7 = 3.6E05_JWRB
      REAL(KIND=JWRB), PARAMETER :: SWELLF7 = 2.3E05_JWRB
!debile test2      REAL(KIND=JWRB), PARAMETER :: Z0RAT = 0.04_JWRB
      REAL(KIND=JWRB), PARAMETER :: Z0RAT = 0.02_JWRB
