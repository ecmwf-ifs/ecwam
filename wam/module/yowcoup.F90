...
#include "outint_io_serv.intfb.h"
      ...
      REAL(KIND=JPRO), ALLOCATABLE :: NSWH(:), NMWP(:)
      REAL(KIND=JPRO), ALLOCATABLE :: NPHIEPS(:), NTAUOC(:)
      REAL(KIND=JPRO), ALLOCATABLE :: NEMOSTRN(:)
      REAL(KIND=JPRO), ALLOCATABLE :: NEMOUSTOKES(:)
      REAL(KIND=JPRO), ALLOCATABLE :: NEMOVSTOKES(:)

      INTEGER(KIND=JWIM) :: NEMONTAU
      REAL(KIND=JPRO), ALLOCATABLE :: NEMOTAUX(:), NEMOTAUY(:)
      REAL(KIND=JPRO), ALLOCATABLE :: NEMONEW10(:), NEMOPHIF(:)

      INTEGER(KIND=JWIM) :: NEMOINIDATE
      INTEGER(KIND=JWIM) :: NEMOINITIME
      INTEGER(KIND=JWIM) :: NEMOITINI
      INTEGER(KIND=JWIM) :: NEMOITEND
      REAL(KIND=JPRO)  :: NEMOTSTEP
