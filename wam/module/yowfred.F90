...
!*    ** *FREDIR* - FREQUENCY AND DIRECTION GRID.
      ...
      REAL(KIND=JWRB), ALLOCATABLE :: DELK_GC(:)
...
!      *XKS_GC*    REAL      WAVE NUMBER LIMIT FOR  THE GRAVITY-CAPILLARY SPECTRUM.
!      *XKL_GC*    REAL      WAVE NUMBER LIMIT FOR  THE GRAVITY-CAPILLARY SPECTRUM.

!      *OMEGA_GC(:)*         ANGULAR FREQUENCY OF THE GRAVITY-CAPILLARY SPECTRUM.
!      *XK_GC(:)*            WAVE NUMBER OF THE GRAVITY-CAPILLARY SPECTRUM.
!      *DELK_GC(:)*          WAVENUMBER SPACING OF THE GRAVITY-CAPILLARY SPECTRUM.
