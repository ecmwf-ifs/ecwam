...
!*    ** *FREDIR* - FREQUENCY AND DIRECTION GRID.
      ...
      REAL(KIND=JWRB), ALLOCATABLE :: C2OSQRTVG(:)
      REAL(KIND=JWRB), ALLOCATABLE :: ZFAK_GC(:)
...
!      *C2OSQRTVG*           C_GC**2/SQRT(VG_GC) 
!      *ZFAK_GC*             OMEGA_GC**2 / (g*XK_GC)
!      *DELKCC_GC*           WAVE NUMBER OF THE GRAVITY-CAPILLARY SPECTRUM SPACING / C2OSQRTVG
