      ...
      REAL(KIND=JWRB), ALLOCATABLE :: WSWAVE(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: WDWAVE(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: UFRIC(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: Z0M(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: Z0B(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: TAUW(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: TAUWDIR(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: CHNK(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: AIRD(:) 
      REAL(KIND=JWRB), ALLOCATABLE :: WSTAR(:) 
...
!     *CHNK*      CHARNOCK COEFFICIENT AT THE BEGINNING OF TIME STEP
