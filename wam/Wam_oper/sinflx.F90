...
IF(LUPDTUS) THEN
  ...
  CALL AIRSEA (KIJS, KIJL, FL1, U10NEW, THWNEW, ROAIRN, TAUW, TAUWDIR, RNFAC, USNEW, Z0NEW, Z0B, ICODE_WND, IUSFG) 
ENDIF
...
IF(ICALL < NCALL ) CALL FLMINTAIL(KIJS, KIJL, U10NEW, THWNEW, USNEW, FMEANWS, FL1) 
