...
! UPDATE TAUW
CALL STRESSO (FL1, SL, SPOS, IJS, IJL, MIJ, RHOWGDFTH, THWNEW, USNEW, Z0NEW, ROAIRN, TAUW, PHIWA, LLPHIWA) 

IF(ICALL == NCALL ) CALL AIRSEA (FL1, FMEAN, FMEANWS, U10NEW, THWNEW, ROAIRN, TAUW, USNEW, Z0NEW, IJS, IJL, ICODE_WND, IUSFG) 
