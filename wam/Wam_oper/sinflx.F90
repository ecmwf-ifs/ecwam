...
INTEGER(KIND=JWIM), INTENT(OUT) :: MIJFLX(IJS:IJL)  !! LAST FREQUENCY INDEX FOR THE PROGNOSTIC RANGE FOR THE FLUXES CALCULATION
...
ELSE
  ...
  ICODE_WND = 3
ENDIF
IF(LUPDTUS) CALL AIRSEA (FL1, FMEAN, FMEANWS, U10NEW, THWNEW, ROAIRN, TAUW, TAUWDIR, USNEW, Z0NEW, IJS, IJL, ICODE_WND, IUSFG) 
...
! UPDATE TAUW
CALL STRESSO (FL1, SL, SPOS, IJS, IJL, MIJFLX, RHOWGDFTH, THWNEW, USNEW, Z0NEW, ROAIRN, TAUW, TAUWDIR, PHIWA, LLPHIWA) 
