...
!$OMP   PARALLEL DO SCHEDULE(STATIC) PRIVATE(ICHNK, KIJS, IJSB, KIJL, IJLB)
        DO ICHNK = 1, NCHNK
          ...
          AIRD(KIJS:KIJL, ICHNK)    = RFIELD(IJSB:IJLB,8)
          WSTAR(KIJS:KIJL, ICHNK)   = RFIELD(IJSB:IJLB,9)
          CICOVER(KIJS:KIJL, ICHNK) = RFIELD(IJSB:IJLB,10)
          CITHICK(KIJS:KIJL, ICHNK) = RFIELD(IJSB:IJLB,11)
          UCUR(KIJS:KIJL, ICHNK)    = RFIELD(IJSB:IJLB,12)
          VCUR(KIJS:KIJL, ICHNK)    = RFIELD(IJSB:IJLB,13)
