      SUBROUTINE WGRIBENCODE_IO_SERV (IU06, ITEST, I1, I2, FIELD, &
...
!**    INTERFACE.
!      ----------
!        *CALL* *WGRIBENCODE_IO_SERV (IU06, ITEST, I1, I2, FIELD,
!                             ITABLE, IPARAM, KLEV, IK, IM,
!                             CDATE, IFCST, MARSTYPE,
!                             IGRIB_HANDLE)
...
! ----------------------------------------------------------------------
      ...
      IF(ITEST.GT.0) THEN
        WRITE(IU06,*) '   SUB. WGRIBENCODE_IO_SERV CALLED FOR ',IPARAM
        CALL FLUSH(IU06)
      ENDIF

!     CLONE GRIB TEMPLATE:
      ! GRIB TEMPLATE ALREADY INITIALIZED
...
!           in hours
        ...
        IF (ICLASS.NE.9.AND.ICLASS.NE.10.AND.ICLASS.NE.11 &
          ...
          WRITE(IU06,*)' SUB: WGRIBENCODE_IO_SERV: THIS IS A FORECAST'
