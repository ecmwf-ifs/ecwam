...
!     TEST471 (modified SWELLF):
      ...
      REAL(KIND=JWRB), DIMENSION(IJS:IJL,NGST) :: XSTRESS_INC_O, YSTRESS_INC_O
      REAL(KIND=JWRB), DIMENSION(IJS:IJL,NGST) :: XSTRESS_INC_N, YSTRESS_INC_N
...
! Initialisation
      ...
      DO IGST=1,NGST
        DO IJ=IJS,IJL
          XSTRESS_INC_O(IJ,IGST)=0.0_JWRB
          XSTRESS_INC_N(IJ,IGST)=0.0_JWRB
          XSTRESS(IJ,IGST)=0.0_JWRB
          YSTRESS_INC_O(IJ,IGST)=0.0_JWRB
          YSTRESS_INC_N(IJ,IGST)=0.0_JWRB
...
!        ---------------------------
      ...
      DO M=1,NFRE
        ...
        DO IGST=1,NGST
          DO IJ=IJS,IJL
            TAUPX=TAUX(IJ,IGST)-ABS_TAUWSHELTER*(XSTRESS(IJ,IGST)+XSTRESS_INC_O(IJ,IGST))
            TAUPY=TAUY(IJ,IGST)-ABS_TAUWSHELTER*(YSTRESS(IJ,IGST)+YSTRESS_INC_O(IJ,IGST))
        ...
        DO K=1,NANG
          ...
          DO IGST=1,NGST
            DO IJ=IJS,IJL
              ...
              XSTRESS_INC_O(IJ,IGST)=XSTRESS_INC_N(IJ,IGST)
              XSTRESS_INC_N(IJ,IGST)=0.5_JWRB*SLP(IJ,IGST)*CONST11(IJ)
              XSTRESS(IJ,IGST)=XSTRESS(IJ,IGST)+XSTRESS_INC_N(IJ,IGST)

              YSTRESS_INC_O(IJ,IGST)=YSTRESS_INC_N(IJ,IGST)
              YSTRESS_INC_N(IJ,IGST)=0.5_JWRB*SLP(IJ,IGST)*CONST22(IJ)
              YSTRESS(IJ,IGST)=YSTRESS(IJ,IGST)+YSTRESS_INC_N(IJ,IGST)
            ENDDO
          ENDDO
