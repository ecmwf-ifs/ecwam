...
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(ICHNK, KIJS, IJSB, KIJL, IJLB)
      DO ICHNK = 1, NCHNK
        ...
        RFIELD(IJSB:IJLB,8)  = AIRD(KIJS:KIJL, ICHNK)
        RFIELD(IJSB:IJLB,9)  = WSTAR(KIJS:KIJL, ICHNK)
        RFIELD(IJSB:IJLB,10) = CICOVER(KIJS:KIJL, ICHNK)
        RFIELD(IJSB:IJLB,11) = CITHICK(KIJS:KIJL, ICHNK)
        RFIELD(IJSB:IJLB,12) = UCUR(KIJS:KIJL, ICHNK) 
        RFIELD(IJSB:IJLB,13) = VCUR(KIJS:KIJL, ICHNK) 
      ENDDO
!$OMP END PARALLEL DO
