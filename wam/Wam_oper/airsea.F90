      SUBROUTINE AIRSEA (FL1, FMEAN, FMEANWS, U10, U10DIR, ROAIRN, TAUW, TAUWDIR, US, Z0, IJS, IJL, ICODE_WND, IUSFG)
...
!       *CALL* *AIRSEA (FL1, U10, U10DIR, ROAIRN, TAUW, TAUWDIR, US, Z0, IJS, IJL, ICODE_WND, IUSFG)*
!          *FL1*  - SPECTRA
!          *FMEAN*  MEAN FREQUENCY
!          *FMEANWS* MEAN FREQUENCY OF THE WINDSEA.
...
#include "z0wave.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION (IJS:IJL), INTENT (IN) :: U10DIR, ROAIRN, TAUW, TAUWDIR
...
!        ----------------------------------
      ...
      IF (ICODE_WND == 3) THEN
        CALL TAUT_Z0 (IJS, IJL, IUSFG, FL1, FMEAN, FMEANWS, U10, U10DIR, ROAIRN, TAUW, TAUWDIR, US, Z0)
