      SUBROUTINE AIRSEA (FL1, FMEAN, FMEANWS, U10, THW, ROAIRN, TAUW, US, Z0, IJS, IJL, ICODE_WND, IUSFG)
...
!       *CALL* *AIRSEA (FL1, U10, THW, ROAIRN, TAUW, US, Z0, IJS, IJL, ICODE_WND, IUSFG)*
!          *FL1*  - SPECTRA
...
#include "z0wave.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION (IJS:IJL), INTENT (IN) :: THW, ROAIRN, TAUW
...
!        ----------------------------------
      ...
      IF (ICODE_WND == 3) THEN
        CALL TAUT_Z0 (IJS, IJL, IUSFG, FL1, FMEAN, FMEANWS, U10, THW, ROAIRN, TAUW, US, Z0)
