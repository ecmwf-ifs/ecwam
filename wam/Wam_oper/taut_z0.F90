SUBROUTINE TAUT_Z0(IJS, IJL, XLEV, FL1, UTOP, ROAIRN, TAUW, USTAR, Z0)
...
!       *CALL* *TAUT_Z0(IJS, IJL, XLEV, UTOP, ROAIRN, TAUW, XLEV, USTAR, Z0)
...
#include "stress_gc.intfb.h"
      ...
      REAL(KIND=JWRB) :: CONST0, OMS, TAUV, DEL
...
!         GRAVITY CAPILLARY CONTRIBUTION:
          CALL STRESS_GC(USTAR(IJ),EPSIL(IJ),Z0(IJ),ALPHAP(IJ),OMS,XMSS(IJ),TAUUNR(IJ))
