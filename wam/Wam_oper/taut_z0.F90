SUBROUTINE TAUT_Z0(IJS, IJL, IUSFG, FL1, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0)
...
!       *CALL* *TAUT_Z0(IJS, IJL, IUSFG, FL1, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0)
...
#include "stress_gc.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(IJS:IJL) :: ANG_GC, ALPHAP, HALP, TAUUNR, ZB
...
!     COMPUTE THE PHILLIPS PARAMETER
      LLBND = .TRUE.
      CALL HALPHAP(IJS, IJL, UDIR, FL1, HALP, LLBND) 
