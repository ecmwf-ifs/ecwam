SUBROUTINE TAUT_Z0(IJS, IJL, KIJS, KIJL, IUSFG, GFL, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0, Z0B)
...
!       *CALL* *TAUT_Z0(IJS, IJL, KIJS, KIJL, IUSFG, GFL, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0, Z0B)
...
#include "stress_gc.intfb.h"
      ...
      INTEGER(KIND=JWIM), INTENT(IN) :: IJS, IJL, KIJS, KIJL, IUSFG
...
!     COMPUTE THE PHILLIPS PARAMETER
      CALL HALPHAP(IJS, IJL, KIJS, KIJL, USTAR, UDIR, GFL, HALP) 
