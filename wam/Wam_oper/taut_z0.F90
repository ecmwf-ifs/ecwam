...
&                  UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, &
&                  USTAR, Z0, Z0B)
...
!       *CALL* *TAUT_Z0(KIJS, KIJL, IUSFG, FL1, WAVNUM, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0, Z0B)
...
#include "stress_gc.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(KIJS:KIJL), INTENT(IN) :: UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC
...
!     CD = ACDLIN + BCDLIN*SQRT(PCHAR) * U10
      ...
      REAL(KIND=JWRB), DIMENSION(KIJS:KIJL) :: ANG_GC, ALPHAP, HALP, TAUUNR
