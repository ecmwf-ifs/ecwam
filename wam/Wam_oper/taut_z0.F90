SUBROUTINE TAUT_Z0(KIJS, KIJL, IUSFG, FL1, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0, Z0B)
...
!       *CALL* *TAUT_Z0(KIJS, KIJL, IUSFG, FL1, UTOP, UDIR, ROAIRN, TAUW, TAUWDIR, RNFAC, USTAR, Z0, Z0B)
...
!     COMPUTE THE PHILLIPS PARAMETER
      CALL HALPHAP(KIJS, KIJL, USTAR, UDIR, FL1, HALP) 
