...
! ----------------------------------------------------------------------
     ...
     &                      BETAMAXOXKAPPA2, BMAXOKAPDTH, GAMNCONST, DELTA_THETA_RN
...
! ----------------------------------------------------------------------
      ...
      BMAXOKAPDTH = DELTH*DELTA_THETA_RN*BETAMAXOXKAPPA2/XKAPPA
!!      GAMNCONST = DELTA_THETA_RN*0.5_JWRB*ZPI**4*GM1*3*BETAMAXOXKAPPA2/XKAPPA
      GAMNCONST = 0.008_JWRB*DELTA_THETA_RN*0.5_JWRB*ZPI**4*GM1*3*BETAMAXOXKAPPA2/XKAPPA
