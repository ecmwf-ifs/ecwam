SUBROUTINE HALPHAP(IJS, IJL, UDIR, FL1, HALP, LLBND)
...
!          *LLBND* - IF TRUE THE PHILLIPS PARAMETER MAXIMUM VALUE WILL BE ALPHAPMAX
!                                                   MINIMUM VALUE WILL BE ALPHAPMIN
...
! ----------------------------------------------------------------------
      ...
      LOGICAL, INTENT(IN) :: LLBND

      REAL(KIND=JWRB), PARAMETER :: ALPHAPMIN=0.0001_JWRB
