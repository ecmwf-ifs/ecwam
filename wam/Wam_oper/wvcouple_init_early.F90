SUBROUTINE WVCOUPLE_INIT_EARLY(YDGEOMETRY)
...
!-------------------------------------------------------------------
	...
	IF(.NOT.LWINIT) THEN
		...
		CALL WVCOUPLE_UPDATE_GRIB_HANDLES(YDGEOMETRY)
		...
		WRITE(*,*) "NGRIB_HANDLE_WAM_I Set to", NGRIB_HANDLE_WAM_I
		WRITE(*,*) "NGRIB_HANDLE_WAM_S Set to", NGRIB_HANDLE_WAM_S
