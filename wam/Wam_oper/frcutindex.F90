      SUBROUTINE FRCUTINDEX (IJS, IJL, FM, FMWS, UFRIC, CICOVER,       &
     &                       MIJ, RHOWGDFTH)
...
!       *CALL* *FRCUTINDEX (IJS, IJL, FM, FMWS, CICOVER, MIJ, RHOWGDFTH)
...
! ----------------------------------------------------------------------
      ...
      REAL(KIND=JWRB),DIMENSION(IJS:IJL), INTENT(IN) :: FM, FMWS, UFRIC, CICOVER
