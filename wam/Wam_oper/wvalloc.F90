...
!         -------------------------
      ...
      IF(.NOT.ALLOCATED(U10OLD)) ALLOCATE(U10OLD(NINF:NSUP))
      IF(.NOT.ALLOCATED(THWOLD)) ALLOCATE(THWOLD(NINF:NSUP))
      IF(.NOT.ALLOCATED(USOLD)) ALLOCATE(USOLD(NINF:NSUP))
      IF(.NOT.ALLOCATED(Z0OLD)) ALLOCATE(Z0OLD(NINF:NSUP))
      IF(.NOT.ALLOCATED(TAUW)) ALLOCATE(TAUW(NINF:NSUP))
      IF(.NOT.ALLOCATED(TAUWDIR)) ALLOCATE(TAUWDIR(NINF:NSUP))
      ...
      IF(.NOT.ALLOCATED(ROAIRO)) ALLOCATE(ROAIRO(NINF:NSUP))
      IF(.NOT.ALLOCATED(ROAIRN)) ALLOCATE(ROAIRN(NINF:NSUP))
      IF(.NOT.ALLOCATED(ZIDLOLD)) ALLOCATE(ZIDLOLD(NINF:NSUP))
      IF(.NOT.ALLOCATED(ZIDLNEW)) ALLOCATE(ZIDLNEW(NINF:NSUP))

      IF(.NOT.ALLOCATED(CICOVER)) ALLOCATE(CICOVER(NINF:NSUP))
      IF(.NOT.ALLOCATED(CITHICK)) ALLOCATE(CITHICK(NINF:NSUP))
      IF(.NOT.ALLOCATED(CIWA)) ALLOCATE(CIWA(NINF:NSUP,NFRE))
