...
USE YOWGRID  , ONLY : IJS, IJL, NLONRGG, NPROMA_WAM, NCHNK, KIJL4CHNK, IJFROMCHNK
...
DO ICHNK = 1, NCHNK
  ...
  IR = IR + 1
  BOUT(IJSB:IJLB, IR) = REAL(MOD(IRANK,65536), JWRB)

  IR = IR + 1
  BOUT(IJSB:IJLB, IR) = REAL(IRANK/65536, JWRB)

  IR = IR + 1
  BOUT(IJSB:IJLB, IR) = REAL(NLOCMSK(IJSB:IJLB), JWRB)

  IR = IR + 1
  BOUT(IJSB:IJLB, IR) = REAL(MOD(NGLOIND(IJSB:IJLB),65536), JWRB)

  IR = IR + 1
  BOUT(IJSB:IJLB, IR) = REAL(NGLOIND(IJSB:IJLB)/65536, JWRB)
