...
!-------------------------------------------------------------------
      ...
      INTEGER(KIND=JWIM), PARAMETER  :: I1PROC = 1_JWIM
      INTEGER(KIND=JWIM), PARAMETER  :: ITAGBC = 0_JWIM
      INTEGER(KIND=JWIM), ALLOCATABLE :: WVCOUNT (:)
      INTEGER(KIND=JWIM)              :: WVCOUNTG
      INTEGER(KIND=JWIM)              :: WVCOUNTMX
      INTEGER(KIND=JWIM)              :: NLONRGG_SIZE_M, NLONRGG_SIZE_IO
...
INTEGER(KIND=JWIM), INTENT (IN) :: KSORTL2G (:,:)
INTEGER(KIND=JWIM), POINTER     :: KSORTCNT (:)
INTEGER(KIND=JWIM), POINTER     :: KSORTOFF (:)
INTEGER(KIND=JWIM) :: I
REAL(KIND=JWRB) :: ZHOOK_HANDLE
...
INTEGER(KIND=JWIM), INTENT (INOUT) :: KWVSSORTL2G (:,:) ! NWVSTOTMX, NPROC
INTEGER(KIND=JWIM), INTENT (INOUT) :: KWVSRANKSET (:,:) ! NPROC, 1
INTEGER(KIND=JWIM) :: IPROC,IGLOBALIDX, ILOCALIDX, IMAPIDX
...
INTEGER(KIND=JWIM),INTENT(IN)  :: KFROM
INTEGER(KIND=JWIM),INTENT(OUT) :: KTO
REAL(KIND=JWRB) :: ZHOOK_HANDLE
...
INTEGER(KIND=JWIM),INTENT(IN)  :: KFROM(N)
INTEGER(KIND=JWIM),INTENT(OUT) :: KTO(N)
REAL(KIND=JWRB) :: ZHOOK_HANDLE
...
REAL(KIND=JWRB),INTENT(IN)  :: PFROM
REAL(KIND=JWRB),INTENT(OUT) :: PTO
REAL(KIND=JWRB) :: ZHOOK_HANDLE
