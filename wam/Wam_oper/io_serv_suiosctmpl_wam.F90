...
!-------------------------------------------------------------------
      ...
      IF (YDIOS%MODELPAR%LWCOU) THEN
            ...
            CALL EXPINT( WVCOUNTG, YDIOS%MODELPAR%NWVTOTG)
            CALL EXPINT( WVCOUNTMX, YDIOS%MODELPAR%NWVTOTMX)
            CALL EXPINT(NGX, YDIOS%MODELPAR%WVNGX)
            CALL EXPINT(NGY, YDIOS%MODELPAR%WVNGY)
...
ALLOCATE ( YDIOS%MODELPAR%IWVSSORTL2G ( YDIOS%MODELPAR%NWVTOTMX,YDIOS%NPROC_WR), &
