SUBROUTINE OUTWSPEC (IJS, IJL, SPEC, MARSTYPE, CDATE, IFCST) 
...
!     SUBROUTINE OUTWSPEC (IJS, IJL, SPEC)
...
USE YOWSTAT  , ONLY : CDATEF   ,CDTPRO   ,NPROMA_WAM
...
REAL(KIND=JWRB), DIMENSION(IJS:IJL, NANG, NFRE), INTENT(IN) :: SIJS, IJL, PEC
