SUBROUTINE OUTBS (IJS, IJL, MIJ, FL1, XLLWS, WVPRPT, WVENVI, FF_NOW, INTFLDS)
! ----------------------------------------------------------------------
...
!      *WVENVI* - WAVE ENVIRONEMENT (depth, currents,...)
...
! ----------------------------------------------------------------------
      ...
      USE YOWDRVTYPE  , ONLY : ENVIRONEMENT, FREQUENCY, FORCING_FIELDS, INTGT_PARAM_FIELDS
