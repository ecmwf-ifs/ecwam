...
!         -----------------------------------------
     ...
     &                   USNEW, ROAIRN, .FALSE.)
        ...
        IF(LWFLUX) THEN
         CALL FEMEANWS(GFL, IJS, IJL, KIJS, KIJL, EMEANWS, FMEANWS, GXLLWS)
        ...
        CALL STOKESDRIFT(GFL, IJS, IJL, KIJS, KIJL, U10NEW, THWNEW, CICVR, USTOKES, VSTOKES)

        IF(LWNEMOCOUSTRN) CALL CIMSSTRN(GFL, IJS, IJL, KIJS, KIJL, STRNMS)
