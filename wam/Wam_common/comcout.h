...
C
      CHARACTER*12 COUTT(MOUTT), COUTLST, COUTS(MOUTS), CASS(MASS)
     ...
     3        NFLAG(JPPFLAG),NFLAGALL, LFDB
      COMMON /COUT/ NGOUT, IGAR(MOUTP), IJAR(MOUTP),
     1              NOUTT, COUTT, COUTLST, NOUTS, COUTS, NASS, CASS,
     ...
     5              NFLAG, NFLAGALL, LFDB, IPFGTBL(JPPFLAG+1)
