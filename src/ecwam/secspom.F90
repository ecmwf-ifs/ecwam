...
!--------------------------------------------------------------------
!
      SUBROUTINE SECSPOM(F1,F3,KIJS,KIJL,NFRE,NANG,NDEPTH,DEPTHA,  &
...
! ----------------------------------------------------------------------
      ...
      INTEGER(KIND=JWIM),INTENT(IN) :: KIJS,KIJL,NFRE,NANG,NDEPTH,MR
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG,NFRE), INTENT(IN) :: F1
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG,NFRE), INTENT(OUT) :: F3
      ...
      INTEGER(KIND=JWIM), DIMENSION(KIJL) :: JD
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL) :: XINCR, DF2KP, DF2KM, PSUM
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG,NMAX) :: F2
