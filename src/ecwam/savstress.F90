...
! ----------------------------------------------------------------------
      ...
      CALL TRACE%INIT(__FILENAME__,__LINE__,"SAVSTRESS")
...
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(ICHNK, KIJS, IJSB, KIJL, IJLB)
      DO ICHNK = 1, NCHNK
        ...
        RFIELD(IJSB:IJLB,13) = FF_NOW%USTRA(KIJS:KIJL,ICHNK)
        RFIELD(IJSB:IJLB,14) = FF_NOW%VSTRA(KIJS:KIJL,ICHNK)
        RFIELD(IJSB:IJLB,15) = WVENVI%UCUR(KIJS:KIJL,ICHNK)
        RFIELD(IJSB:IJLB,16) = WVENVI%VCUR(KIJS:KIJL,ICHNK)
      ENDDO
!$OMP END PARALLEL DO
