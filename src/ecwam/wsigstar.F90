...
!
      ...
      SUBROUTINE WSIGSTAR (KIJS, KIJL, WSWAVE, UFRIC, Z0M, WSTAR, SIG_N, SIG_U10)
! ----------------------------------------------------------------------
...
! ----------------------------------------------------------------------
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: SIG_N, SIG_U10
      ...
      REAL(KIND=JWRB), PARAMETER :: SIG_U10MAX = 0.9_JWRB ! MAX OF RELATIVE STANDARD DEVIATION OF U10
      ...
      REAL(KIND=JWRB) :: BCD_LOC, U10M1, ZN, Z0VIS
...
! ----------------------------------------------------------------------
      ...
      IF (LLGCBZ0 .OR. LLNORMAGAM) THEN
        ...
        DO IJ=KIJS,KIJL
          ...
          BCD_LOC = BCDLIN*SQRT(ZCHAR)
          C_D = ACDLIN + BCD_LOC * WSWAVE(IJ)
          DC_DDU = BCD_LOC
...
!
        ...
        DO IJ=KIJS,KIJL
          U10 = UFRIC(IJ)*XKAPPAD*(LOG(10.0_JWRB)-LOG(Z0M(IJ)))
          U10 = MAX(U10,WSPMIN)
          U10M1=1.0_JWRB/U10
          C2U10P1=C2*U10**P1
          U10P2=U10**P2
