...
SUBROUTINE SINFLX_BYDBR (ICALL, NCALL, KIJS, KIJL,  &
 &                 LUPDTUS,                   &
 &                 FL1,                       &
...
!**** *SINFLX_BYDBR* - COMPUTATION OF INPUT SOURCE FUNCTION AND STRESSES
...
!     *CALL* *SINFLX_BYDBR (NGST, LLSNEG, KIJS, KIJL, FL1,
!    &                    WAVNUM, CGROUP, CINV, XK2CG,
