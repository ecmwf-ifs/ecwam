...
CALL GSTATS_LABEL(619,'MPL','BROADCAST IN INWGRIB IN WAM ')
...
CALL GSTATS_LABEL(694,'MPL','GETBOBSTRCT WAM ')
...
CALL GSTATS_LABEL(1497,'OMP','WAM GETBOBSTRCT')
CALL GSTATS_LABEL(1498,'OMP','WAM GETGRBOBSTRCT')
...
CALL GSTATS_LABEL(1771,'IO-','GETBOBSTRCT WAM I/O ')
