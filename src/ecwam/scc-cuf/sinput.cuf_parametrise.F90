...
MODULE SINPUT_CUF_PARAMETRISE_MOD
  ...
  & UFRIC, Z0M, COSWDIF, SINWDIF2, RAORW, WSTAR, RNFAC, FLD, SL, SPOS, XLLWS, IJ)
    ...
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM) :: WAVNUM, CINV, XK2CG
    ...
    REAL(KIND=JWRB), INTENT(OUT), DIMENSION(KIJL, NANG_LOKI_PARAM, NFRE_LOKI_PARAM) :: XLLWS
