...
MODULE YOWINDN
  ...
  INTEGER(KIND=JWIM), DEVICE :: KFRH_D
  INTEGER(KIND=JWIM), DEVICE :: MLSTHG_D
  INTEGER(KIND=JWIM), DEVICE :: MFRSTLW_D
  REAL(KIND=JWRB), DEVICE :: DAL2_D
  REAL(KIND=JWRB), DEVICE :: DAL1_D
