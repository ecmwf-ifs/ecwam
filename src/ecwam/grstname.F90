...
! ----------------------------------------------------------------------
      ...
      INTEGER(KIND=JWIM) :: NDAY, ISHIFTDAY
      INTEGER(KIND=JWIB) :: ISHIFT
      INTEGER(KIND=JWIM) :: IYEARSEC, IDAYSEC
...
!          -------------------------
      ...
      IDDDDDD=ISHIFT/IDAYSEC
      IHH=MOD(ISHIFT,IDAYSEC)/3600 !(ISHIFT-IDDDDDD*86400)/3600
      IMIMI=MOD(ISHIFT,3600)/60    !(ISHIFT-IDDDDDD*86400-IHH*3600)/60
      ISS=MOD(ISHIFT,60)           !ISHIFT-IDDDDDD*86400-IHH*3600-IMIMI*60
