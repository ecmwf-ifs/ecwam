...
!*    ** *COUT*  OUTPUT POINTS INDICES AND FLAGS.
      ...
      INTEGER(KIND=JWIM), PARAMETER :: JPPFLAG=75+3*NTRAIN+5 !!!! change also in scripts: wave_setgflag
      ...
      CHARACTER(LEN=32):: COUTDESCRIPTION(JPPFLAG)
      ...
      INTEGER(KIND=JWIM) :: IRWDIR,IRCD,IRU10,IRHS,IRTP,IRT1,IRPHIAW,IRPHIOC,IRTAUOC,IRMSS
...
!      *IRMSS  *   INTEGER   INDEX IN IPFGTBL OF MSS
...
!      *NTEWH*     INTEGER   NUMBER OF OUTPUT FIELDS THAT ARE COMPUTED FOR PERIOD INTETVAL
...
!                            IPRMINFO(:,4)  : IF USED, OTHERWISE SET TO 0:
!                                             MINIMUM WAVE PERIOD OF THE INTERVAL OVER WHICH THE PARAMETER IS DETERMINED
!                            IPRMINFO(:,5)  : IF USED, OTHERWISE SET TO 0: 
!                                             MAXIMUM WAVE PERIOD OF THE INTERVAL OVER WHICH THE PARAMETER IS DETERMINED
...
!                            INFOBOUT(:,4)  : MINIMUM WAVE PERIOD OF THE INTERVAL OVER WHICH THE PARAMETER IS DETERMINED
!                            INFOBOUT(:,5)  : MAXIMUM WAVE PERIOD OF THE INTERVAL OVER WHICH THE PARAMETER IS DETERMINED
...
!      *F_BOUT*              FIELD_API STORAGE OBJECT FOR OUTPUT PARAMETER BUFFER
! ----------------------------------------------------------------------
      END MODULE YOWCOUT
