...
! -------------------------------------------------------------------
     ...
     &                      MODEL_TIME
      USE YOWSPEC, ONLY   : NBLKS    ,NBLKE, XLLWS, MIJ
...
!        ----------------------------
      ...
      CALL FL1%SYNC_DEVICE_RDWR(QUEUE=0)
      ...
      CALL XLLWS%SYNC_DEVICE_RDWR(QUEUE=2)
...
!*    BRANCHING BACK TO 1.0 FOR NEXT PROPAGATION STEP.
      ...
      CALL FL1%GET_HOST_DATA_RDWR()
      CALL XLLWS%GET_HOST_DATA_RDWR()
      ...
      CALL FL1%DELETE_DEVICE_DATA()
      CALL XLLWS%DELETE_DEVICE_DATA()
