...
!     IPHYS2_AIRSEA: 1: ITERATIVE METHOD FOR THE AIR-SEA INTERACTION (U10, USTAR, CHARN, Z0)
!     IPHYS2_AIRSEA: 2: USE U10 DIRECTLY TO DRIVE THE WIND INPUT
...
!     patial initialisation of the output table
      ...
      IPHYS     = 1
      IPHYS2_AIRSEA = 2
      LLLOWWINDS = .TRUE. ! .TRUE. if low winds are treated differently
      ISNONLIN  = 1 
      IDAMPING  = 1 
      IPROPAGS  = 0 
      IREFRA    = 0 
