...
!     ----------
      ...
      INTEGER(KIND=JWIM) :: NSPEC, ISPECS, ISPECE, NANG, NFRE
!                  ARRAY DIMENSIONS.
...
!     ----------------
      ...
      INTEGER(KIND=JWIM), ALLOCATABLE ::  GAP(:,:,:)
!                   ASSIGNMENT OF A GAP NUMBER TO A 
!                   FREQUENCY-DIRECTIONAL BIN.
      INTEGER(KIND=JWIM) :: ISPEC, IGAP, JGAP, KGAP, IANG, IFRE
!                    LOOP INDICES.
      INTEGER(KIND=JWIM) :: IANGP1, IANGM1, IFREM1
!                    "IANG PLUS 1" , "IANG MINUS 1" , "IFRE PLUS 1".
      INTEGER(KIND=JWIM) :: LANG0, HANG0, LFRE0, HFRE0
!                    FOR TEMPORARILY STORAGE.
      INTEGER(KIND=JWIM) :: MAXNGAP
!                    THE MAXIMAL NUMBER OF GAPS OCCURING IN ONE 
!                    SPECTRUM.
      INTEGER(KIND=JWIM) :: GAP0
!                    TEMPORARILY USE.
...
!               |  JJJJ  |  | JJJJ   |  |JJJJJ   |  |JJJ     |
     ...
     &              MAX(LANG(ISPEC,IGAP),LANG(ISPEC,JGAP))       ) THEN
                ...
                ENDIF
              ELSEIF (WRAPI .AND. .NOT.WRAPJ) THEN
!               CASES:
...
!               | JJJ    |  | JJJJ   |  | JJJJJJ |  |   JJJJ |  |     JJJ |
                ...
                IF (LANG0.LE.HANG0) THEN
                  ...
                  HANG0 = NANG
                ENDIF
              ELSEIF (WRAPJ.AND..NOT.WRAPI) THEN
!               CASES:
...
!       -------------------------------------
     ...
     &       LFRE(ISPEC,IGAP).EQ.HFRE(ISPEC,IGAP)     ) THEN
