...
!!    IF THE NUMBER OF FREQUENCY IF 30/36 THEN DO THE SAME FOR THE LAST 5.
...
!     ----------
      ...
      INTEGER(KIND=JWIM) :: ISPEC, IPART, JPART, KPART, KANG, KFRE, NBINEXC
!                   LOOP INDEXES.
      REAL(KIND=JWRB) :: F0, FX0, FY0
!                   WORK SPACE.
