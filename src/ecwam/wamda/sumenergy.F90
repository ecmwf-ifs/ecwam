...
!                  LOOP INDEXES.
      REAL(KIND=JWRB) :: FX, FY
!                  WAVE NUMBERS.
      REAL(KIND=JWRB) :: FACTOR 
...
!     ---------------------------
      ...
      DO IPART = 1,MPART
        DO ISPEC = 1,NSPEC
          MEANE(ISPEC,IPART) = 0.0_JWRB
          SUMX(ISPEC,IPART) = 0.0_JWRB
          SUMY(ISPEC,IPART) = 0.0_JWRB
          SUMXX(ISPEC,IPART) = 0.0_JWRB
          SUMYY(ISPEC,IPART) = 0.0_JWRB
        END DO
      END DO
      ...
      DO IFRE = 1,NFRE
        ...
        DO IPART = 1,MPART
          DO ISPEC = 1,NSPEC
            ...
            SUMXX0(ISPEC,IPART) = 0.0_JWRB 
            SUMYY0(ISPEC,IPART) = 0.0_JWRB 
          END DO
        END DO
     ...
     &          = SUM0(ISPEC,PART(ISPEC,IANG,IFRE))  + SPEC(ISPEC,IANG,IFRE)
            SUMX0(ISPEC,PART(ISPEC,IANG,IFRE))                          &
     &          = SUMX0(ISPEC,PART(ISPEC,IANG,IFRE)) + FX * SPEC(ISPEC,IANG,IFRE)
            SUMXX0(ISPEC,PART(ISPEC,IANG,IFRE))                         &
     &          = SUMXX0(ISPEC,PART(ISPEC,IANG,IFRE)) + FX**2 * SPEC(ISPEC,IANG,IFRE)
            SUMY0(ISPEC,PART(ISPEC,IANG,IFRE))                          &
     &          = SUMY0(ISPEC,PART(ISPEC,IANG,IFRE)) + FY * SPEC(ISPEC,IANG,IFRE)
            SUMYY0(ISPEC,PART(ISPEC,IANG,IFRE))                         &
     &          = SUMYY0(ISPEC,PART(ISPEC,IANG,IFRE)) + FY**2 * SPEC(ISPEC,IANG,IFRE)
          END DO
        END DO

        DO IPART = 1,MPART
          DO ISPEC = 1,NSPEC
            MEANE(ISPEC,IPART) = MEANE(ISPEC,IPART) + DFIM(IFRE) * SUM0(ISPEC,IPART) 
            SUMX(ISPEC,IPART)  = SUMX(ISPEC,IPART)  + DFIM(IFRE) * SUMX0(ISPEC,IPART) 
            SUMY(ISPEC,IPART)  = SUMY(ISPEC,IPART)  + DFIM(IFRE) * SUMY0(ISPEC,IPART)
            SUMXX(ISPEC,IPART) = SUMXX(ISPEC,IPART) + DFIM(IFRE) * SUMXX0(ISPEC,IPART)
            SUMYY(ISPEC,IPART) = SUMYY(ISPEC,IPART) + DFIM(IFRE) * SUMYY0(ISPEC,IPART)
          END DO
        END DO
      END DO
...
!     ---------------
      ...
      DO IPART = 1,MPART
        DO ISPEC = 1,NSPEC
          MEANE(ISPEC,IPART) = MEANE(ISPEC,IPART) + FACTOR * SUM0(ISPEC,IPART)
        END DO
      END DO
...
!     --------------
      ...
      DO IPART = 1,MPART
        DO ISPEC = 1,NSPEC
          IF(MEANE(ISPEC,IPART).GT.0.0_JWRB) THEN
