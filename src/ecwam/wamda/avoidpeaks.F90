...
!     ----------
      ...
      INTEGER(KIND=JWIM):: NSPEC, ISPECS, ISPECE, MGAP, MPART, NANG,NFRE
!                 DIMENSIONS.
...
!                  LOOP INDICES.
      INTEGER(KIND=JWIM):: IANGP1, IANGM1, IFREP1, IFREM1
!                  LOOP INDICES + OR - 1
!     LOWER AND UPPER LIMIT ON FIRST DIMENSION POINTINF TO NUMBER OF 
!     SPECTRA.
      REAL(KIND=JWRB):: SPEC0
!                  TEMPORARY STORAGE
!-------------------------------------------------------------------
