...
#include "abort1.intfb.h"
      ...
      INTEGER(KIND=JWIM), ALLOCATABLE :: I2DUM(:,:)
      INTEGER(KIND=JWIM), ALLOCATABLE :: I1DUM(:)
      REAL(KIND=JWRB), ALLOCATABLE :: R2DUM(:,:)

      INTEGER(KIND=JWIM) :: IMOD,MAXJPSIW
!                FUTURE FIRST AND SECOND INDEX OF RESIZABLE ARRAYS
      INTEGER(KIND=JWIM) :: I, J, NEWNSPECW, NEWJPSIW

      INTEGER(KIND=JWIM) :: NSIW1D0
!             DEFAULT VALUE FOR ARRAY NSIW1D 

      REAL(KIND=JWRB) :: DEFAULT_DIST
