...
!      *LWFLUX_IMPCOR LOGICAL   IF TRUE WAVE RADIATIVE STRESSES FOR SEA ICE MODEL ARE CORRECTED BY THE IMPLICIT FACTOR
...
CONTAINS
      ...
      SUBROUTINE OUTINT_IO_SERV (NIPRMOUT, NINFOBOUT, BOUT, INFOBOUT, MARSTYPE, CDATE, IFCST)
      USE PARKIND_WAVE, ONLY : JWIM, JWRB
      USE YOWGRID     , ONLY : NPROMA_WAM, NCHNK
      USE YOWABORT,     ONLY : WAM_ABORT
      IMPLICIT NONE
      ...
      CALL OUTINT_IO_SERV_HANDLER (NIPRMOUT, NINFOBOUT, BOUT, INFOBOUT, MARSTYPE, CDATE, IFCST)
