...
! ----------------------------------------------------------------------
      ...
      DO IJ = KIJS,KIJL
        ...
        ALPFAC(IJ) = (1-NINT(IBRMEM(IJ)))*ALPFAC(IJ) + NINT(IBRMEM(IJ))*ZALPFACXINV
        
!         THIS IS A SAFER CODE BLOCK IN CASE IBRMEM ISN'T WELL DEFINED EVERYWHERE 
