...
REAL(KIND=JWRB), DIMENSION(NINF:NSUP,2), INTENT(INOUT) :: WLATM1 ! 1 - WLAT
REAL(KIND=JWRB), DIMENSION(NINF:NSUP,4), INTENT(INOUT) :: WCORM1 ! 1 - WCOR
REAL(KIND=JWRB), DIMENSION(NINF:NSUP,2), INTENT(INOUT) :: DP     ! COS PHI FACTOR
