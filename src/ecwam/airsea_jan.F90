...
!
      ...
      SUBROUTINE AIRSEA_JAN (KIJS, KIJL, &
&                        HALP, U10, U10DIR, TAUW, TAUWDIR, RNFAC,  &
&                        US, Z0, Z0B, CHRNCK, ICODE_WND, IUSFG)

! ----------------------------------------------------------------------

!**** *AIRSEA_JAN* - DETERMINE TOTAL STRESS IN SURFACE LAYER.
...
!       *CALL* *AIRSEA_JAN (KIJS, KIJL, FL1, WAVNUM,
!                       HALP, U10, U10DIR, TAUW, TAUWDIR, RNFAC,
!                       US, Z0, Z0B, CHRNCK, ICODE_WND, IUSFG)*
...
! ----------------------------------------------------------------------
      IF (LHOOK) CALL DR_HOOK ('AIRSEA_JAN', 0, ZHOOK_HANDLE)
...
!        ---------------------------
      ...
      ELSE
        WRITE (IU06, * ) ' ++++++++++++++++++++++++++++++++++++++++++'
        WRITE (IU06, * ) ' + AIRSEA_JAN : INVALID VALUE OF ICODE_WND    +'
        WRITE (IU06, * ) ' ICODE_WND = ', ICODE_WND
        WRITE (IU06, * ) ' ++++++++++++++++++++++++++++++++++++++++++'
        CALL ABORT1
      ENDIF

      IF (LHOOK) CALL DR_HOOK ('AIRSEA_JAN', 1, ZHOOK_HANDLE)

      END SUBROUTINE AIRSEA_JAN
