...
!
      ...
      SUBROUTINE SDISSIP_BYDBR (KIJS, KIJL, FL1, FLD, SL,          &
     &                        WAVNUM, CGROUP, XK2CG,             &
     &                        UFRIC, COSWDIF, RAORW)
! ----------------------------------------------------------------------

!**** *SDISSIP_BYDBR* - COMPUTATION OF DISSIPATION SOURCE FUNCTION.
...
! ----------------------------------------------------------------------
      ...
      IF (LHOOK) CALL DR_HOOK('SDISSIP_BYDBR',0,ZHOOK_HANDLE)
...
!/T6     271 FORMAT (' TEST W3SDS6 : Total SDS  =',E13.5)
      ...
      IF (LHOOK) CALL DR_HOOK('SDISSIP_BYDBR',1,ZHOOK_HANDLE)

      END SUBROUTINE SDISSIP_BYDBR
