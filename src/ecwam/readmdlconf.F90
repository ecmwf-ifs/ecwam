...
!     --------------------------------------
      ...
      IF(.NOT. ALLOCATED(DELLAM) ) DEALLOCATE(DELLAM)
      ALLOCATE(DELLAM(NGY))
      IF(.NOT. ALLOCATED(SINPH) ) DEALLOCATE(SINPH) 
      ALLOCATE(SINPH(NGY))
      IF(.NOT. ALLOCATED(COSPH) ) DEALLOCATE(COSPH)
      ALLOCATE(COSPH(NGY))
      IF(.NOT. ALLOCATED(ZDELLO) ) DEALLOCATE(ZDELLO)
      ALLOCATE(ZDELLO(NGY))
