      SUBROUTINE FRCUTINDEX_ZBRY (KIJS, KIJL, FM, UFRIC, CICOVER,     &
            &                       MIJ)
...
!       *CALL* *FRCUTINDEX_ZBRY (KIJS, KIJL, FM, UFRIC, CICOVER,MIJ)
...
! ----------------------------------------------------------------------
      ...
      REAL(KIND=JWRB),DIMENSION(KIJL), INTENT(IN) :: FM, UFRIC, CICOVER
...
! ----------------------------------------------------------------------
      ...
      IF (LHOOK) CALL DR_HOOK('FRCUTINDEX_ZBRY',0,ZHOOK_HANDLE)
      ...
      IF (LHOOK) CALL DR_HOOK('FRCUTINDEX_ZBRY',1,ZHOOK_HANDLE)

      END SUBROUTINE FRCUTINDEX_ZBRY
