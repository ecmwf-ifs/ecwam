...
#include "wsigstar.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL,NGST) :: SIGDEV ,US, Z0, UCN, ZCN
      REAL(KIND=JWRB), DIMENSION(KIJL,NGST) :: USTPM1
      REAL(KIND=JWRB), DIMENSION(KIJL,NGST) :: XVD, UCND, CONST3_UCN2
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG) :: UFAC1, UFAC2
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG) :: TEMPD
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG,NGST) :: GAM0
