...
! ----------------------------------------------------------------------
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: U10
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: USTAR
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: Z0M
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: Z0B
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: CHRNCK
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: BETAM 
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: BETAHQ
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT), OPTIONAL :: CD
...
!     ----------------------
      ...
      IF (LLGCBZ0) THEN
        ALPHAMAXU10(KIJS:KIJL)=ALPHAMAX
      ELSE
        ALPHAMAXU10(KIJS:KIJL)=MIN(ALPHAMAX,AMAX+BMAX*U10(KIJS:KIJL))
      ENDIF
