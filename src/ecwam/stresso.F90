...
!     ----------------------------------------------------------------------------------
     ...
     &                UST, TAUHF, PHIHF, LLPHIWA)
      ...
      ! this is the end of the IPHYS=0,1 relevant part            
!     ---------------------------------------------------------------------------------
!     ---------------------------------------------------------------------------------
!     ---------------------------------------------------------------------------------
!     ---------------------------------------------------------------------------------
...
!     ---------------------------------------------------------------------------------
      ...
      ! essentially the same as what is done in LFACTOR


      ! this is the end of the IPHYS=2 relevant part                
!     ---------------------------------------------------------------------------------
!     ---------------------------------------------------------------------------------
!     ---------------------------------------------------------------------------------
!     ---------------------------------------------------------------------------------
