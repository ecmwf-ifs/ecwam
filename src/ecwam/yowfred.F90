...
!*    ** *FREDIR* - FREQUENCY AND DIRECTION GRID.
      ...
      REAL(KIND=JWRB), ALLOCATABLE :: DF(:)
      REAL(KIND=JWRB), ALLOCATABLE :: SIG(:)
      REAL(KIND=JWRB), ALLOCATABLE :: DDEN(:)
      REAL(KIND=JWRB), ALLOCATABLE :: SIGM1(:)
      REAL(KIND=JWRB), ALLOCATABLE :: DSII(:)
      REAL(KIND=JWRB), ALLOCATABLE :: SIG_EXT(:)
      REAL(KIND=JWRB), ALLOCATABLE :: DSII_EXT(:)
      REAL(KIND=JWRB), ALLOCATABLE :: IFRE_EXT(:)
