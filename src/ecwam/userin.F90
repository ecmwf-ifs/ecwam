...
!     ICE WATER DRAG COEFFICIENT
      ...
      IF (LCIWA1) WRITE (IU06,*)  ' ICE ATTENUATION DUE TO SCATTERING ACTIVATED'
      IF (LCIWA2) WRITE (IU06,*)  ' ICE ATTENUATION TO BOTTOM FRICTION ACTIVATED'
      IF (LCIWA3) WRITE (IU06,*)  ' ICE ATTENUATION TO VISCOUS FRICTION ACTIVATED'
