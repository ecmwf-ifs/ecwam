...
! ----------------------------------------------------------------------
      ...
      USE YOWCOUP  , ONLY : LWCOU, LIFS_IO_SERV_ENABLED, IO_SERV_WV_OUTINT
      USE PARKIND_WAVE, ONLY : JWIM, JWRB, JWRU
...
!         See arpifs/io_serv directory
          CALL IO_SERV_WV_OUTINT(NIPRMOUT, NINFOBOUT, BOUT, INFOBOUT, MARSTYPE, CDATE, IFCST)
      ELSE
