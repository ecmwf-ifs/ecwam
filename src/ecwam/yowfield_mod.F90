   ...
   CONTAINS
      ...
      SUBROUTINE FREQUENCY_FINAL(SELF)
          ...
          IF(ASSOCIATED(SELF%F_WAVNUM))THEN
              CALL SELF%F_WAVNUM%FINAL()
              DEALLOCATE(SELF%F_WAVNUM)
          ENDIF
          IF(ASSOCIATED(SELF%F_CINV))THEN
              CALL SELF%F_CINV%FINAL()
              DEALLOCATE(SELF%F_CINV)
          ENDIF
          IF(ASSOCIATED(SELF%F_CGROUP))THEN
              CALL SELF%F_CGROUP%FINAL()
              DEALLOCATE(SELF%F_CGROUP)
          ENDIF
          IF(ASSOCIATED(SELF%F_XK2CG))THEN
              CALL SELF%F_XK2CG%FINAL()
              DEALLOCATE(SELF%F_XK2CG)
          ENDIF
          IF(ASSOCIATED(SELF%F_OMOSNH2KD))THEN
              CALL SELF%F_OMOSNH2KD%FINAL()
              DEALLOCATE(SELF%F_OMOSNH2KD)
          ENDIF
          IF(ASSOCIATED(SELF%F_STOKFAC))THEN
              CALL SELF%F_STOKFAC%FINAL()
              DEALLOCATE(SELF%F_STOKFAC)
          ENDIF
          IF(ASSOCIATED(SELF%F_CIWA))THEN
              CALL SELF%F_CIWA%FINAL()
              DEALLOCATE(SELF%F_CIWA)
          ENDIF
      ...
      SUBROUTINE ENVIRONMENT_FINAL(SELF)
          ...
          IF(ASSOCIATED(SELF%F_INDEP))THEN
              CALL SELF%F_INDEP%FINAL()
              DEALLOCATE(SELF%F_INDEP)
          ENDIF
          IF(ASSOCIATED(SELF%F_IODP))THEN
              CALL SELF%F_IODP%FINAL()
              DEALLOCATE(SELF%F_IODP)
          ENDIF
          IF(ASSOCIATED(SELF%F_IOBND))THEN
              CALL SELF%F_IOBND%FINAL()
              DEALLOCATE(SELF%F_IOBND)
          ENDIF
          IF(ASSOCIATED(SELF%F_DELLAM1))THEN
              CALL SELF%F_DELLAM1%FINAL()
              DEALLOCATE(SELF%F_DELLAM1)
          ENDIF
          IF(ASSOCIATED(SELF%F_COSPHM1))THEN
              CALL SELF%F_COSPHM1%FINAL()
              DEALLOCATE(SELF%F_COSPHM1)
          ENDIF
          IF(ASSOCIATED(SELF%F_DEPTH))THEN
              CALL SELF%F_DEPTH%FINAL()
              DEALLOCATE(SELF%F_DEPTH)
          ENDIF
          IF(ASSOCIATED(SELF%F_EMAXDPT))THEN
              CALL SELF%F_EMAXDPT%FINAL()
              DEALLOCATE(SELF%F_EMAXDPT)
          ENDIF
          IF(ASSOCIATED(SELF%F_UCUR))THEN
              CALL SELF%F_UCUR%FINAL()
              DEALLOCATE(SELF%F_UCUR)
          ENDIF
          IF(ASSOCIATED(SELF%F_VCUR))THEN
              CALL SELF%F_VCUR%FINAL()
              DEALLOCATE(SELF%F_VCUR)
          ENDIF
      ...
      SUBROUTINE FORCING_FIELDS_FINAL(SELF)
          ...
          IF(ASSOCIATED(SELF%F_UWND))THEN
              CALL SELF%F_UWND%FINAL()
              DEALLOCATE(SELF%F_UWND)
          ENDIF
          IF(ASSOCIATED(SELF%F_VWND))THEN
              CALL SELF%F_VWND%FINAL()
              DEALLOCATE(SELF%F_VWND)
          ENDIF
          IF(ASSOCIATED(SELF%F_AIRD))THEN
              CALL SELF%F_AIRD%FINAL()
              DEALLOCATE(SELF%F_AIRD)
          ENDIF
          IF(ASSOCIATED(SELF%F_WSTAR))THEN
              CALL SELF%F_WSTAR%FINAL()
              DEALLOCATE(SELF%F_WSTAR)
          ENDIF
          IF(ASSOCIATED(SELF%F_CICOVER))THEN
              CALL SELF%F_CICOVER%FINAL()
              DEALLOCATE(SELF%F_CICOVER)
          ENDIF
          IF(ASSOCIATED(SELF%F_CITHICK))THEN
              CALL SELF%F_CITHICK%FINAL()
              DEALLOCATE(SELF%F_CITHICK)
          ENDIF
          IF(ASSOCIATED(SELF%F_LKFR))THEN
              CALL SELF%F_LKFR%FINAL()
              DEALLOCATE(SELF%F_LKFR)
          ENDIF
          IF(ASSOCIATED(SELF%F_UCUR))THEN
              CALL SELF%F_UCUR%FINAL()
              DEALLOCATE(SELF%F_UCUR)
          ...
          IF(ASSOCIATED(SELF%F_WSWAVE))THEN
              CALL SELF%F_WSWAVE%FINAL()
              DEALLOCATE(SELF%F_WSWAVE)
          ENDIF
          IF(ASSOCIATED(SELF%F_WDWAVE))THEN
              CALL SELF%F_WDWAVE%FINAL()
              DEALLOCATE(SELF%F_WDWAVE)
          ENDIF
          IF(ASSOCIATED(SELF%F_UFRIC))THEN
              CALL SELF%F_UFRIC%FINAL()
              DEALLOCATE(SELF%F_UFRIC)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUW))THEN
              CALL SELF%F_TAUW%FINAL()
              DEALLOCATE(SELF%F_TAUW)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUWDIR))THEN
              CALL SELF%F_TAUWDIR%FINAL()
              DEALLOCATE(SELF%F_TAUWDIR)
          ENDIF
          IF(ASSOCIATED(SELF%F_Z0M))THEN
              CALL SELF%F_Z0M%FINAL()
              DEALLOCATE(SELF%F_Z0M)
          ENDIF
          IF(ASSOCIATED(SELF%F_Z0B))THEN
              CALL SELF%F_Z0B%FINAL()
              DEALLOCATE(SELF%F_Z0B)
          ENDIF
          IF(ASSOCIATED(SELF%F_CHRNCK))THEN
              CALL SELF%F_CHRNCK%FINAL()
              DEALLOCATE(SELF%F_CHRNCK)
          ENDIF
          IF(ASSOCIATED(SELF%F_XLON))THEN
              CALL SELF%F_XLON%FINAL()
              DEALLOCATE(SELF%F_XLON)
          ENDIF
          IF(ASSOCIATED(SELF%F_YLAT))THEN
              CALL SELF%F_YLAT%FINAL()
              DEALLOCATE(SELF%F_YLAT)
          ENDIF
      ...
      SUBROUTINE WAVE2OCEAN_FINAL(SELF)
          ...
          IF(ASSOCIATED(SELF%F_NSWH))THEN
              CALL SELF%F_NSWH%FINAL()
              DEALLOCATE(SELF%F_NSWH)
          ENDIF
          IF(ASSOCIATED(SELF%F_NMWP))THEN
              CALL SELF%F_NMWP%FINAL()
              DEALLOCATE(SELF%F_NMWP)
          ENDIF
          IF(ASSOCIATED(SELF%F_NPHIEPS))THEN
              CALL SELF%F_NPHIEPS%FINAL()
              DEALLOCATE(SELF%F_NPHIEPS)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOPHIF))THEN
              CALL SELF%F_NEMOPHIF%FINAL()
              DEALLOCATE(SELF%F_NEMOPHIF)
          ENDIF
          IF(ASSOCIATED(SELF%F_NTAUOC))THEN
              CALL SELF%F_NTAUOC%FINAL()
              DEALLOCATE(SELF%F_NTAUOC)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOTAUX))THEN
              CALL SELF%F_NEMOTAUX%FINAL()
              DEALLOCATE(SELF%F_NEMOTAUX)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOTAUY))THEN
              CALL SELF%F_NEMOTAUY%FINAL()
              DEALLOCATE(SELF%F_NEMOTAUY)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOUSTOKES))THEN
              CALL SELF%F_NEMOUSTOKES%FINAL()
              DEALLOCATE(SELF%F_NEMOUSTOKES)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOVSTOKES))THEN
              CALL SELF%F_NEMOVSTOKES%FINAL()
              DEALLOCATE(SELF%F_NEMOVSTOKES)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOSTRN))THEN
              CALL SELF%F_NEMOSTRN%FINAL()
              DEALLOCATE(SELF%F_NEMOSTRN)
          ENDIF
          IF(ASSOCIATED(SELF%F_NEMOWSWAVE))THEN
              CALL SELF%F_NEMOWSWAVE%FINAL()
              DEALLOCATE(SELF%F_NEMOWSWAVE)
          ENDIF
      ...
      SUBROUTINE INTGT_PARAM_FIELDS_FINAL(SELF)
          ...
          IF(ASSOCIATED(SELF%F_WSEMEAN))THEN
              CALL SELF%F_WSEMEAN%FINAL()
              DEALLOCATE(SELF%F_WSEMEAN)
          ENDIF
          IF(ASSOCIATED(SELF%F_WSFMEAN))THEN
              CALL SELF%F_WSFMEAN%FINAL()
              DEALLOCATE(SELF%F_WSFMEAN)
          ENDIF
          IF(ASSOCIATED(SELF%F_USTOKES))THEN
              CALL SELF%F_USTOKES%FINAL()
              DEALLOCATE(SELF%F_USTOKES)
          ENDIF
          IF(ASSOCIATED(SELF%F_VSTOKES))THEN
              CALL SELF%F_VSTOKES%FINAL()
              DEALLOCATE(SELF%F_VSTOKES)
          ENDIF
          IF(ASSOCIATED(SELF%F_PHIEPS))THEN
              CALL SELF%F_PHIEPS%FINAL()
              DEALLOCATE(SELF%F_PHIEPS)
          ENDIF
          IF(ASSOCIATED(SELF%F_PHIOCD))THEN
              CALL SELF%F_PHIOCD%FINAL()
              DEALLOCATE(SELF%F_PHIOCD)
          ENDIF
          IF(ASSOCIATED(SELF%F_PHIAW))THEN
              CALL SELF%F_PHIAW%FINAL()
              DEALLOCATE(SELF%F_PHIAW)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUOC))THEN
              CALL SELF%F_TAUOC%FINAL()
              DEALLOCATE(SELF%F_TAUOC)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUXD))THEN
              CALL SELF%F_TAUXD%FINAL()
              DEALLOCATE(SELF%F_TAUXD)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUYD))THEN
              CALL SELF%F_TAUYD%FINAL()
              DEALLOCATE(SELF%F_TAUYD)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUOCXD))THEN
              CALL SELF%F_TAUOCXD%FINAL()
              DEALLOCATE(SELF%F_TAUOCXD)
          ENDIF
          IF(ASSOCIATED(SELF%F_TAUOCYD))THEN
              CALL SELF%F_TAUOCYD%FINAL()
              DEALLOCATE(SELF%F_TAUOCYD)
          ENDIF
          IF(ASSOCIATED(SELF%F_STRNMS))THEN
              CALL SELF%F_STRNMS%FINAL()
              DEALLOCATE(SELF%F_STRNMS)
          ENDIF
          IF(ASSOCIATED(SELF%F_ALTWH))THEN
              CALL SELF%F_ALTWH%FINAL()
              DEALLOCATE(SELF%F_ALTWH)
          ENDIF
          IF(ASSOCIATED(SELF%F_CALTWH))THEN
              CALL SELF%F_CALTWH%FINAL()
              DEALLOCATE(SELF%F_CALTWH)
          ENDIF
          IF(ASSOCIATED(SELF%F_RALTCOR))THEN
              CALL SELF%F_RALTCOR%FINAL()
              DEALLOCATE(SELF%F_RALTCOR)
          ENDIF
      ...
      SUBROUTINE SOURCE_CONTRIBS_FINAL(SELF)
          ...
          IF(ASSOCIATED(SELF%F_FL1))THEN
              CALL SELF%F_FL1%FINAL()
              DEALLOCATE(SELF%F_FL1)
          ENDIF
          IF(ASSOCIATED(SELF%F_XLLWS))THEN
              CALL SELF%F_XLLWS%FINAL()
              DEALLOCATE(SELF%F_XLLWS)
          ENDIF
          IF(ASSOCIATED(SELF%F_MIJ))THEN
              CALL SELF%F_MIJ%FINAL()
              DEALLOCATE(SELF%F_MIJ)
          ENDIF
