...
INTEGER, INTENT(IN)  :: IU06, KGRIB_HANDLE
INTEGER, INTENT(OUT) :: NGX, NGY, IPER, IRGG, IQGAUSS
INTEGER, ALLOCATABLE, DIMENSION(:), INTENT(OUT) :: KLONRGG
LOGICAL, INTENT(OUT) :: LLSCANNS
REAL, INTENT(OUT)    :: AMOWEP, AMOSOP, AMOEAP, AMONOP, XDELLA, XDELLO
