...
!        ------------------------------------
      ...
      WRITE (IU06,'('' MOST SOUTHERN LATITUDE IS AMOSOP = '',F9.5)') AMOSOP
      WRITE (IU06,'('' MOST NORTHERN LATITUDE IS AMONOP = '',F9.5)') AMONOP 
      WRITE (IU06,'('' LATITUDE INCREMENT IS     XDELLA = '',F9.5)') XDELLA
      WRITE (IU06,'(''0MAX NUMBER OF LONGITUDES IS  NGX = '',I5)') NGX
      WRITE (IU06,'('' MOST WESTERN LONGITUDE IS AMOWEP = '',F9.5)') AMOWEP
      WRITE (IU06,'('' MOST EASTERN LONGITUDE IS AMOEAP = '',F9.5)') AMOEAP
      WRITE (IU06,                                                      &
