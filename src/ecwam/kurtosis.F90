...
#include "h_max.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: C3, C4, BF2, QP, HMAX, TMAX
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: ETA_M, R, XNSLC, SIG_TH, EPS, XNU
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL) :: HMAXN
      REAL(KIND=JWRB), DIMENSION(KIJL) :: SUM0,SUM1,SUM2,SUM4,SUM40,SUM6
      REAL(KIND=JWRB), DIMENSION(KIJL) :: XKP,SIG_OM
      REAL(KIND=JWRB), DIMENSION(KIJL) :: SIG_HM
      REAL(KIND=JWRB), DIMENSION(KIJL) :: F_M,OM_UP
      REAL(KIND=JWRB), DIMENSION(KIJL) :: AA,BB,C4_DYN,C4_B
      REAL(KIND=JWRB), DIMENSION(KIJL) :: FFMAX
      REAL(KIND=JWRB), DIMENSION(KIJL,NFRE) :: FF 
