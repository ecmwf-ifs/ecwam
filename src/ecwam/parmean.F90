...
! ----------------------------------------------------------------------
      ...
      INTEGER(KIND=JWIM), INTENT(IN), DIMENSION(KIJL) :: NPEAK
      REAL(KIND=JWRB), INTENT(IN) :: SPEC(NANG,NFRE,NPMAX,KIJL)
      REAL(KIND=JWRB), INTENT(OUT), DIMENSION(KIJL,0:NPMAX) :: ENE, DIR, PER
