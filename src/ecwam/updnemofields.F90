...
! -------------------------------------------------------------------   
      ...
      REAL(KIND=JWRO), DIMENSION(NTOTIJ) :: NSWH, NMWP, NWNUM, NPHIEPS, NTAUOC
...
!$OMP  PARALLEL DO SCHEDULE(STATIC) PRIVATE(ICHNK, KIJS, IC, KIJL)
       DO ICHNK = 1, NCHNK
          ...
          NWNUM(KIJS:KIJL)       = WAM2NEMO%NWNUM(1:KIJL4CHNK(ICHNK), ICHNK)
          ...
          NEMOTAUICX(KIJS:KIJL)  = WAM2NEMO%NEMOTAUICX(1:KIJL4CHNK(ICHNK), ICHNK)
          NEMOTAUICY(KIJS:KIJL)  = WAM2NEMO%NEMOTAUICY(1:KIJL4CHNK(ICHNK), ICHNK)
...
!$OMP  END PARALLEL DO
     ...
     &                               NTOTIJ,                               &
     &                               NSWH, NMWP, NWNUM, NPHIEPS, NTAUOC,   &
