...
!
      ...
      INTEGER(KIND=JWIM), PARAMETER :: NUMALT=11
      ...
      REAL(KIND=JWRB) :: ALTGRTHRSH(NUMALT)
...
!     *ALTGRTHRSH* REAL   THRESHOLD FOR GROSS ERROR CHECK (SEE GRFIELD).
...
!     *LECWAMDA* LOGICAL  CONTROLS ECMWF SPECIFC OPTIONS IN THE WAVE DATA ANALYIS SYSTEM
!     *LODBRALT* LOGICAL  CONTROLS THE USE OF ODB FOR RADAR ALTIMETER OBS.
!     *LRALTPREPROC* LOGICAL  CONTROLS WHETHER RADAR ALTIMETER OBS ARE PREPROCESSED BY RFL4WAM (ONLY IF LODBRALT IS FALSE).
