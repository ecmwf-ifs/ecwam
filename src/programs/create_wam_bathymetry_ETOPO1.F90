...
!       FOR INTEGRATED PARAMETERS
        CALL PRESET_WGRIB_TEMPLATE("I",NGRIB_HANDLE_WAM_I,LLCREATE=.true.,NBITSPERVALUE=24)
!       FOR SPECTRA
        CALL PRESET_WGRIB_TEMPLATE("S",NGRIB_HANDLE_WAM_S,LLCREATE=.true.,NBITSPERVALUE=12)
