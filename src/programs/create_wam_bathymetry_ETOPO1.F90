...
!!    PENHCOR is used to enhanced the corner onstructructions for IPROPAGS=2 
      ...
      REAL(KIND=JWRB), ALLOCATABLE, DIMENSION(:,:) :: BOOST_OBSTR
...
!          IF 60% OR MORE LAND OR THE CENTER OF THE GRID BOX IS LAND, THEN AVERAGE OVER LAND POINTS
...
!                 WAVE COMPONENT WILL BE ATTENUATED BY THE RATIO OF ALL BLOCKING SUBGRID POINTS TO THE TOTAL NUMBER OF POINTS
                  ...
                  IOBSLAT(IX,K,IS) = MAX(IOBSLAT(IX,K,IS), 0.0_JWRB) 
...
!                 WAVE COMPONENT WILL BE ATTENUATED BY THE RATIO OF ALL BLOCKING SUBGRID POINTS TO THE TOTAL NUMBER OF POINTS
                  ...
                  IOBSLON(IX,K,IS) = MAX(IOBSLON(IX,K,IS), 0.0_JWRB) 
