...
MODULE WNFLUXES_CUF_PARAMETRISE_MOD
  ...
  & TAUOCYD, TAUOC, PHIOCD, PHIEPS, PHIAW, LNUPD, IJ)
    ...
    REAL(KIND=JWRB), INTENT(IN), DEVICE, DIMENSION(KIJL) :: WSWAVE, WDWAVE
    REAL(KIND=JWRB), INTENT(IN), DEVICE, DIMENSION(KIJL) :: UFRIC, AIRD
    REAL(KIND=JWRB), INTENT(INOUT), DEVICE, DIMENSION(KIJL) :: TAUXD, TAUYD, TAUOCXD, TAUOCYD, TAUOC
    REAL(KIND=JWRB), INTENT(INOUT), DEVICE, DIMENSION(KIJL) :: PHIOCD, PHIEPS, PHIAW
    REAL(KIND=JWRO), INTENT(INOUT), DEVICE, DIMENSION(KIJL) :: NPHIEPS, NTAUOC, NSWH, NMWP, NEMOTAUX
    REAL(KIND=JWRO), INTENT(INOUT), DEVICE, DIMENSION(KIJL) :: NEMOTAUY, NEMOWSWAVE, NEMOPHIF
    LOGICAL, VALUE, INTENT(IN) :: LNUPD
    
    
    INTEGER(KIND=JWIM) :: K, M, II
