...
!
MODULE AKI_ICE_CUF_PARAMETRISE_MOD
  CONTAINS
  ATTRIBUTES(DEVICE) FUNCTION AKI_ICE_CUF_PARAMETRISE (G, XK, DEPTH, RHOW, CITH)
    ...
    REAL(KIND=JWRB) :: AKI_ICE_CUF_PARAMETRISE
...
!$loki routine seq
    ...
    AKI_ICE_CUF_PARAMETRISE = AKI
    
  END FUNCTION AKI_ICE_CUF_PARAMETRISE
END MODULE AKI_ICE_CUF_PARAMETRISE_MOD
