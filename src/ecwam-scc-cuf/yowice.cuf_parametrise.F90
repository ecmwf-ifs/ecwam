...
MODULE YOWICE
  ...
  !--------------------------------------------------------------------
  REAL(KIND=JWRB), DEVICE :: CITHRSH_D
  LOGICAL, DEVICE :: LWAMRSETCI_D
  LOGICAL, DEVICE :: LICERUN_D
  REAL(KIND=JWRB), DEVICE :: CITHRSH_TAIL_D
  REAL(KIND=JWRB), DEVICE :: CIBLOCK_D
  REAL(KIND=JWRB), DEVICE :: CDICWA_D
  LOGICAL, DEVICE :: LMASKICE_D
  LOGICAL, DEVICE :: LCIWABR_D
END MODULE YOWICE
