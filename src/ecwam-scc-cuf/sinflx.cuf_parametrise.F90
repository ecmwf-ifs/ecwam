...
MODULE SINFLX_CUF_PARAMETRISE_MOD
  ...
  & FLD, SL, SPOS, MIJ, RHOWGDFTH, XLLWS, IJ)
    ...
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, NANG_LOKI_PARAM, NFRE_LOKI_PARAM) :: FL1    !! WAVE SPECTRUM.
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM) :: WAVNUM    !! WAVE NUMBER.
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM) :: CINV    !! INVERSE PHASE VELOCITY.
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM) :: XK2CG    !! (WAVNUM)**2 * GROUP SPPED.
    ...
    REAL(KIND=JWRB), INTENT(OUT), DIMENSION(KIJL, NANG_LOKI_PARAM, NFRE_LOKI_PARAM) :: XLLWS    !! TOTAL WINDSEA MASK FROM INPUT SOURCE TERM.
