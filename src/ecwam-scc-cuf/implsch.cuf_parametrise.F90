...
MODULE IMPLSCH_CUF_PARAMETRISE_MOD
  ...
  & USTOKES, VSTOKES, STRNMS, TAUXD, TAUYD, TAUOCXD, TAUOCYD, TAUOC, PHIOCD, PHIEPS, PHIAW, MIJ, XLLWS, ENH, NCHNK)
    ...
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, NANG_LOKI_PARAM, NFRE_LOKI_PARAM, NCHNK) :: FL1
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM, NCHNK) :: WAVNUM
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM, NCHNK) :: CGROUP
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM, NCHNK) :: CIWA
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM, NCHNK) :: CINV
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM, NCHNK) :: XK2CG
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NFRE_LOKI_PARAM, NCHNK) :: STOKFAC
    
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NCHNK) :: EMAXDPT
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NCHNK) :: DEPTH
    INTEGER(KIND=JWIM), INTENT(IN), DIMENSION(KIJL, NCHNK) :: INDEP
    INTEGER(KIND=JWIM), INTENT(IN), DIMENSION(KIJL, NCHNK) :: IODP
    INTEGER(KIND=JWIM), INTENT(IN), DIMENSION(KIJL, NCHNK) :: IOBND
    
    REAL(KIND=JWRB), INTENT(IN), DIMENSION(KIJL, NCHNK) :: WDWAVE, CICOVER, AIRD, WSTAR, CITHICK
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: UFRIC, TAUW, TAUWDIR, Z0M, Z0B, CHRNCK, WSWAVE
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: WSEMEAN, WSFMEAN, USTOKES, VSTOKES, STRNMS
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: TAUXD, TAUYD, TAUOCXD, TAUOCYD, TAUOC, PHIOCD
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: PHIEPS, PHIAW
    REAL(KIND=JWRO), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: NEMOUSTOKES, NEMOVSTOKES, NEMOSTRN
    REAL(KIND=JWRO), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: NPHIEPS, NTAUOC, NSWH, NMWP, NEMOTAUX
    REAL(KIND=JWRO), INTENT(INOUT), DIMENSION(KIJL, NCHNK) :: NEMOTAUY, NEMOWSWAVE, NEMOPHIF
    INTEGER(KIND=JWIM), INTENT(OUT), DIMENSION(KIJL, NCHNK) :: MIJ
    REAL(KIND=JWRB), INTENT(OUT), DIMENSION(KIJL, NANG_LOKI_PARAM, NFRE_LOKI_PARAM, NCHNK) :: XLLWS
    REAL(KIND=JWRB), INTENT(INOUT), DIMENSION(KIJL, MLSTHG_D, NCHNK) :: ENH
